...
//            + TableData.TableInfo.COLUMN_NAME_PLAYERSCORE + "INTEGER" + TableData.TableInfo.COLUMN_NAME_PLAYERID +"INTEGER PRIMARY KEY"+")";
//
...
//
//    @Override
//    public void onUpgrade(SQLiteDatabase agr0, int arg1,int arg2, int arg3){
//
//    }
